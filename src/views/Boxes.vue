    ...
    <v-row class="mb-8" dense>
      ...
      <v-col cols="12" sm="6" md="3">
        <BaseStatCard
          icon="mdi-database"
          label="Items"
          :value="boxStore.totalComponents || 0"
          subtitle="Components"
          color="info"
          gradient="info"
        />
          ...
          <BaseCard variant="default" elevation="0" class="box-card">
            <div class="pa-3">
              ...
              <div class="text-center">
                ...
                <h3 class="text-subtitle-2 font-weight-bold mb-1 text-truncate">
                  {{ box.box_label }}
                </h3>
